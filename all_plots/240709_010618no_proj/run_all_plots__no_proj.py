...
description = 'no_proj'  # Put a nice description here as it gets saved in the output directory name and code output file
...
def generate_plots(edf_file, output_directory):
    try:
        ...
        for i, event in enumerate(events):
            ...
            psd_fig = cropped_raw.compute_psd(picks=eeg_channels, fmin=1, fmax=40).plot(dB=False, show=False)  # Set dB=False here
