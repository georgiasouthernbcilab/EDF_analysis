...
description = f'mt_{muscle_threshold}eogt_{eog_threshold}db_{dB}'  # Put a nice description here as it gets saved in the output directory name and code output file
