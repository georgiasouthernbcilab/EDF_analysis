...
def generate_plots(edf_file, output_directory):
    try:
        ...
        raw_clean = ica.apply(
            inst = raw.copy(), # The instance
            # include = None, # Optional
            # exclude = None, # Optional parameter
            # n_pca_components = None, #TODO: Experiment with this optional parameter
            # start = None,
            # stop = None,
            # *, #Optional arguments could go here
        ...
        for i, event in enumerate(events):
            ...
            start = start + 15      #NOTE: Key breakpoint here!
            stop = start + 44       #NOTE: Key breakpoint here!
            try:
