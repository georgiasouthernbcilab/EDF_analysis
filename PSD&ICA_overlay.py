...
description = 'ICAfilter'  # Put a nice description here as it gets saved in the output directory name and code output file
# EEG channels do not need to be rigidly defined, except that it can help restrict the data during other operations
...
output_directory = 'ICA_and_PSD' # NOTE: Date gets added to the end

plot_overlay = False #Save plot overlay?
plot_power_spectral_density = True # Save PSD plot?
...
def main(parent_directory, output_directory):
    ...
    for edf_file in edf_files:  # Process EDF files one at a time
        ...
        if plot_power_spectral_density:
