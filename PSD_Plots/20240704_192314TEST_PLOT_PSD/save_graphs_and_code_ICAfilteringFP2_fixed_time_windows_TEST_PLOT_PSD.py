...
description = 'TEST_PLOT_PSD' # Put a nice description here as it gets saved in the output directory name and code output file
...
def plot_psd(edf_file, output_directory):
    try:
        ...
        for i, event in enumerate(events):
            ...
            fig_epoch = psd_epoch.plot(dB=False, show=False).gca().set_ylim(ylim_orig)  # Set dB=False here
